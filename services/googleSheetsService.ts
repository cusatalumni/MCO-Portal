...
const ALL_EXAMS: Exam[] = [
    ...
    { id: 'exam-ccs-cert', name: 'CCS Certification Exam', productSku: 'CCS-CERT-EXAM', productSlug: 'ccs-certification-exam', description: 'A comprehensive test series for the AHIMA CCS (Certified Coding Specialist) credential, focusing on inpatient coding scenarios with 100 questions.', price: 180, questionSourceUrl: '', numberOfQuestions: 100, passScore: 70, certificateTemplateId: 'cert-ccs', isPractice: false, durationMinutes: 150 },
    // Billing
    ...
    { id: 'exam-mta-cert', name: 'Medical Terminology & Anatomy Certification', productSku: 'MTA-CERT', productSlug: 'medical-terminology-anatomy-certification', description: 'A foundational test series covering core medical terminology and anatomy. Essential for all aspiring medical coders. Includes 100 questions.', price: 80, questionSourceUrl: '', numberOfQuestions: 100, passScore: 70, certificateTemplateId: 'cert-mta', isPractice: false, durationMinutes: 150 },
];
