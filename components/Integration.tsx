...
function annapoorna_get_all_app_data() {
    ...
    $ALL_EXAMS = [
        ...
        // Certification Exams
        ['id' => 'CPC-CERT-EXAM', 'name' => 'CPC Certification Exam', 'description' => 'Full certification exam for Certified Professional Coder.', 'price' => 150, 'regularPrice' => 150, 'productSku' => 'CPC-CERT-EXAM', 'productSlug' => 'exam-cpc-cert-exam', 'numberOfQuestions' => 100, 'passScore' => 70, 'certificateTemplateId' => 'cert-mco-1', 'isPractice' => false, 'durationMinutes' => 240],
        ['id' => 'CCA-CERT-EXAM', 'name' => 'CCA Certification Exam', 'description' => 'Full certification exam for Certified Coding Associate.', 'price' => 120, 'regularPrice' => 120, 'productSku' => 'CCA-CERT-EXAM', 'productSlug' => 'exam-cca-cert-exam', 'numberOfQuestions' => 100, 'passScore' => 70, 'certificateTemplateId' => 'cert-mco-1', 'isPractice' => false, 'durationMinutes' => 180],
        ['id' => 'CCS-CERT-EXAM', 'name' => 'CCS Certification Exam', 'description' => 'Full certification exam for Certified Coding Specialist.', 'price' => 160, 'regularPrice' => 160, 'productSku' => 'CCS-CERT-EXAM', 'productSlug' => 'exam-ccs-cert-exam', 'numberOfQuestions' => 120, 'passScore' => 70, 'certificateTemplateId' => 'cert-mco-1', 'isPractice' => false, 'durationMinutes' => 240],
        ['id' => 'MEDICAL-BILLING-CERT', 'name' => 'Medical Billing Certification Exam', 'description' => 'Comprehensive exam covering medical billing and reimbursement.', 'price' => 100, 'regularPrice' => 100, 'productSku' => 'MEDICAL-BILLING-CERT', 'productSlug' => 'exam-medical-billing-cert', 'numberOfQuestions' => 80, 'passScore' => 75, 'certificateTemplateId' => 'cert-mco-2', 'isPractice' => false, 'durationMinutes' => 150],
        ...
        ['id' => 'ICD-10-CM-CERT', 'name' => 'ICD-10-CM Certification Exam', 'description' => 'Proficiency exam for ICD-10-CM coding.', 'price' => 90, 'regularPrice' => 90, 'productSku' => 'ICD-10-CM-CERT', 'productSlug' => 'exam-icd-10-cm-cert', 'numberOfQuestions' => 75, 'passScore' => 75, 'certificateTemplateId' => 'cert-mco-1', 'isPractice' => false, 'durationMinutes' => 120],
        ['id' => 'CPB-CERT-EXAM', 'name' => 'CPB Certification Exam', 'description' => 'Full certification exam for Certified Professional Biller.', 'price' => 150, 'regularPrice' => 150, 'productSku' => 'CPB-CERT-EXAM', 'productSlug' => 'exam-cpb-cert-exam', 'numberOfQuestions' => 135, 'passScore' => 70, 'certificateTemplateId' => 'cert-mco-2', 'isPractice' => false, 'durationMinutes' => 240],
        ...
        ['id' => 'CPMA-CERT-EXAM', 'name' => 'CPMA Certification Exam', 'description' => 'Full certification exam for Certified Professional Medical Auditor.', 'price' => 150, 'regularPrice' => 150, 'productSku' => 'CPMA-CERT-EXAM', 'productSlug' => 'exam-cpma-cert-exam', 'numberOfQuestions' => 100, 'passScore' => 70, 'certificateTemplateId' => 'cert-mco-1', 'isPractice' => false, 'durationMinutes' => 240],
        ['id' => 'COC-CERT-EXAM', 'name' => 'COC Certification Exam', 'description' => 'Full certification exam for Certified Outpatient Coder.', 'price' => 150, 'regularPrice' => 150, 'productSku' => 'COC-CERT-EXAM', 'productSlug' => 'exam-coc-cert-exam', 'numberOfQuestions' => 100, 'passScore' => 70, 'certificateTemplateId' => 'cert-mco-1', 'isPractice' => false, 'durationMinutes' => 240],
        ['id' => 'CIC-CERT-EXAM', 'name' => 'CIC Certification Exam', 'description' => 'Full certification exam for Certified Inpatient Coder.', 'price' => 150, 'regularPrice' => 150, 'productSku' => 'CIC-CERT-EXAM', 'productSlug' => 'exam-cic-cert-exam', 'numberOfQuestions' => 40, 'passScore' => 70, 'certificateTemplateId' => 'cert-mco-1', 'isPractice' => false, 'durationMinutes' => 240],
        ['id' => 'MTA-CERT', 'name' => 'Medical Terminology & Anatomy Exam', 'description' => 'Proficiency exam for Medical Terminology and Anatomy.', 'price' => 75, 'regularPrice' => 75, 'productSku' => 'MTA-CERT', 'productSlug' => 'exam-mta-cert', 'numberOfQuestions' => 50, 'passScore' => 80, 'certificateTemplateId' => 'cert-mco-1', 'isPractice' => false, 'durationMinutes' => 60]
    ];
